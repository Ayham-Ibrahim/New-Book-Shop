...
<nav class="navbar navbar-expand-lg fixed-top" style="background-color: white;height:55px;opacity: 0.9;border-bottom: 1px solid #cbcbcb;box-shadow: 0 1px 6px 0px #20a7aa;">
...
<div class="background" style="opacity: 0.2;width: 100%;height: 100%;position: fixed;top: 0;bottom: 0;background-image: url('siteimg/about.png');background-size: cover;filter: blur(2px);"></div>
        ...
        <div class="card bg-glass">
            ...
            <?php foreach($up as $uu) : ?>
                 ...
                 <form action="includes/API/updated.php" method="POST" style="padding: inherit;" enctype="multipart/form-data">
                    <h5 class="fw-bold text-center" style="letter-spacing: 2px;font-size:30px;color:#20a7aa;padding-left:10px;padding-bottom:20px;">Update your Book</h5>
