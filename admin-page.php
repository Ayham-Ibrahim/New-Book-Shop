...
<nav class="navbar navbar-expand-lg fixed-top" style="background-color: white;height:55px;border: 1px solid gray;box-shadow: 0 0px 3px;">
    <div class="container-fluid">
        <a class="navbar-brand me-2" href="">
            <h1 class="logo" style="font-size: 36px;font-weight: 600;font-family: initial;margin-left:20px;margin-top: 5px;color:black;"><img src="./siteimg/logo.png" alt="" width="60px">Book<span style="color: #089da1;">Shop</span></h1>
        </a>
        <!-- ------------------------------- -->
        ...
        <div class="collapse navbar-collapse" id="mytoggler">
            ...
            <ul class="navbar-nav d-flex">
                <a href="add-new-product.php" class="add-pro-btn"> Add New Product</a>
                <a href="add-new-category.php" class="add-pro-btn"> Add New category</a>
...
<main class="user_product">
    <div class="container text-center">
        <div class="row gy-5">
            <h3 class="admin-book fw-bold pb-3" style="letter-spacing: 2px;color: #20a7aa;">Our Books</h3>
            <form class="form-inline d-flex justify-content-center md-form form-sm mt-0" method="GET" action="user-page.php" style="margin-bottom: 30px;">
                <input class="search form-control form-control-sm ml-3 w-75" type="text" placeholder="Search by the name of the book" aria-label="Search" name="search_query" style="box-shadow: 0 0px 8px #089da1;">
                ...
                <div class="ProCol col-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div>
                                <a href='includes\API\delete-product.php?id=<?php echo $prod['id']; ?>' class="delete-pro-btn"><i class='fa fa-trash'></i> remove</a>
