...
<main class="user_product">
    <div class="container text-center">
        ...
        <?php endif; ?>
        <div class="row gy-5">
            <h3 class="admin-book mine fw-bold pb-3" style="letter-spacing: 2px;color: rgb(8 157 161);">Our Books</h3>
                            ...
                            <div class="pro-img-box">   
                                ...
                                <div class="black-bar">
                                    <form action="includes/API/addToFavorites.php" method="post">
                                        <a href="book-details.php?id=<?php echo $prod['id']; ?>" class="card-btn" style="display: inline-block;">details</a>
                                        <input type="hidden" name="book_id" value="<?php echo $prod['id']; ?>">
                                        <button type="submit" name="upload" class="add-to-favorite card-btn"><i class='fa fa-plus-circle' style='color:#ffffff;' title="Add to Favorites"></i></button>
                                    </form>
                                </div>
                            </div>
